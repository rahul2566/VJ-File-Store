...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('TXT EXTRACTOR', url='https://t.me/NOOBDAEXTRACTORBOT')
            ],[
            InlineKeyboardButton('🔍 MOVIE GROUP', url='https://t.me/moviedillu'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/KUKUFMBACKUP')
            ],[
